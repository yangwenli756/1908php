...
<body>
<center><h1>管理员的修改</h1></center>
<form  action="{{url('/register/update',$data->id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="password" disabled id="firstname"
                   placeholder="请输入密码">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="pass" disabled  id="firstname"
                   placeholder="请输入密码">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="tel" value="{{$data->tel}}" id="firstname"
                   placeholder="请输入手机号">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <img src="{{env('UPLOAD_URL')}}{{$data->head}}" width="30" height="30">
